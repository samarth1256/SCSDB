  ...
  return (
    <div className='flex flex-wrap h-full w-full px-[5%] bg-[#1F1E24]'>
      {data.map((c,i)=>(
        ...
        <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] object-cover h-[40vh]' src={c.poster_path||c.backdrop_path||c.profile_path?`https://image.tmdb.org/t/p/original/${c.poster_path||c.backdrop_path||c.profile_path}`:noimage}/>
